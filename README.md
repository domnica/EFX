...
Go to the bottom of the file and provide n (the number of agents), m (the number of items), and v (the valuation matrix). Or type enter for each option to skip it and go with a default setting.
